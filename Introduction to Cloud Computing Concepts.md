...
Since I cannot generate a visual diagram directly, I will describe a simple cloud architecture in detail, which you can recreate using tools like Draw.io or the AWS Management Console:
